...
export const COACH_ARCHETYPES: Record<CoachArchetype, CoachArchetypeInfo> = {
  stoic_mentor: {
    id: 'stoic_mentor',
    name: 'Estoico Sabio (Marco Aurelio)',
    shortName: 'Filosófico',
    icon: '🏛️',
    tagline: 'Virtud, Templanza & Perspectiva Cósmica',
    description: 'Guía reflexiva inspirada en Marco Aurelio y Séneca. Transforma cualquier obstáculo en el camino mediante la serenidad mental y el Amor Fati.',
  },
  spartan_commander: {
    id: 'spartan_commander',
    name: 'Estoico Disciplinario (Epicteto)',
    shortName: 'Disciplinario',
    icon: '⚔️',
    tagline: 'Dicotomía del Control & Rigor Inquebrantable',
    description: 'Mentor de batalla fundamentado en el autodominio de Epicteto. Exige tu máximo esfuerzo con templanza de hierro, sin quejas ni gritos vacíos.',
  },
  sports_scientist: {
    id: 'sports_scientist',
    name: 'Estoico Analítico (Crisipo)',
    shortName: 'Analítico',
    icon: '🔬',
    tagline: 'Lógica Objetiva & Telemetría Sin Juicios',
    description: 'Inspirado en la lógica estoica de Crisipo. Biomecánica, balance autonómico y métricas cuantitativas como herramientas para observar la realidad pura.',
  },
};
